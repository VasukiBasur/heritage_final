...
text = re.sub(r'@app\.route\(\'/supplier/schedule/api/new\', methods=\[\'POST\'\]\).*?return jsonify\(\{\'success\': False, \'message\': \'Database connection failed\'\}\), 500', new_routes, text, flags=re.DOTALL)
