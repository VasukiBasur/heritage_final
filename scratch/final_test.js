                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm text-gray-300">
                            ...
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                ...
                                <td class="p-4 text-gray-400">May 28, 2026 10:15 AM</td>
                                <td class="p-4">Customer 1</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 0</td>
                            ...
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8889</td>
                                <td class="p-4 text-gray-400">May 28, 2026 11:18 AM</td>
                                <td class="p-4">Customer 2</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 1</td>
                                <td class="p-4">6 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8888</td>
                                <td class="p-4 text-gray-400">May 28, 2026 12:21 AM</td>
                                <td class="p-4">Customer 3</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 2</td>
                                <td class="p-4">7 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8887</td>
                                <td class="p-4 text-gray-400">May 28, 2026 13:24 AM</td>
                                <td class="p-4">Customer 4</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 3</td>
                                <td class="p-4">8 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8886</td>
                                <td class="p-4 text-gray-400">May 28, 2026 14:27 AM</td>
                                <td class="p-4">Customer 5</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 4</td>
                                <td class="p-4">9 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8885</td>
                                <td class="p-4 text-gray-400">May 27, 2026 15:30 AM</td>
                                <td class="p-4">Customer 6</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 5</td>
                                <td class="p-4">10 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8884</td>
                                <td class="p-4 text-gray-400">May 27, 2026 16:33 AM</td>
                                <td class="p-4">Customer 7</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 6</td>
                                <td class="p-4">11 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8883</td>
                                <td class="p-4 text-gray-400">May 27, 2026 17:36 AM</td>
                                <td class="p-4">Customer 8</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 7</td>
                                <td class="p-4">12 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8882</td>
                                <td class="p-4 text-gray-400">May 27, 2026 10:39 AM</td>
                                <td class="p-4">Customer 9</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 8</td>
                                <td class="p-4">13 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8881</td>
                                <td class="p-4 text-gray-400">May 27, 2026 11:42 AM</td>
                                <td class="p-4">Customer 10</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 9</td>
                                <td class="p-4">14 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8880</td>
                                <td class="p-4 text-gray-400">May 26, 2026 12:45 AM</td>
                                <td class="p-4">Customer 11</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 10</td>
                                <td class="p-4">5 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8879</td>
                                <td class="p-4 text-gray-400">May 26, 2026 13:48 AM</td>
                                <td class="p-4">Customer 12</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 11</td>
                                <td class="p-4">6 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8878</td>
                                <td class="p-4 text-gray-400">May 26, 2026 14:51 AM</td>
                                <td class="p-4">Customer 13</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 12</td>
                                <td class="p-4">7 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8877</td>
                                <td class="p-4 text-gray-400">May 26, 2026 15:54 AM</td>
                                <td class="p-4">Customer 14</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 13</td>
                                <td class="p-4">8 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8876</td>
                                <td class="p-4 text-gray-400">May 26, 2026 16:57 AM</td>
                                <td class="p-4">Customer 15</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 14</td>
                                <td class="p-4">9 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8875</td>
                                <td class="p-4 text-gray-400">May 25, 2026 17:60 AM</td>
                                <td class="p-4">Customer 16</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 15</td>
                                <td class="p-4">10 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8874</td>
                                <td class="p-4 text-gray-400">May 25, 2026 10:63 AM</td>
                                <td class="p-4">Customer 17</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 16</td>
                                <td class="p-4">11 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8873</td>
                                <td class="p-4 text-gray-400">May 25, 2026 11:66 AM</td>
                                <td class="p-4">Customer 18</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 17</td>
                                <td class="p-4">12 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8872</td>
                                <td class="p-4 text-gray-400">May 25, 2026 12:69 AM</td>
                                <td class="p-4">Customer 19</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 18</td>
                                <td class="p-4">13 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                            <tr class="border-b border-gray-800/50 hover:bg-[#1a1a1a] transition-colors">
                                <td class="p-4 font-bold text-white">#ORD-8871</td>
                                <td class="p-4 text-gray-400">May 25, 2026 13:72 AM</td>
                                <td class="p-4">Customer 20</td>
                                <td class="p-4 truncate max-w-[150px]">Handloom Silk 19</td>
                                <td class="p-4">14 km</td>
                                <td class="p-4"><span class="px-2 py-1 bg-green-500/20 text-green-500 rounded text-xs font-bold border border-green-500/30">Delivered</span></td>
                            </tr>
                        </tbody>
            ...
            <div id="tab-messages" class="tab-content h-[700px]">
                <div class="glass-panel rounded-2xl border border-gray-800 flex h-full overflow-hidden">
                    <div class="w-1/3 border-r border-gray-800 flex flex-col">
                        ...
                        <div class="flex-1 overflow-y-auto" id="del-contacts-list">
                            <div id="del-contact-hq" onclick="switchDelContact('hq')" class="p-4 border-b border-gray-800 hover:bg-[#1a1a1a] cursor-pointer bg-[#1a1a1a] transition-colors">
                            ...
                            <div id="del-contact-anjali" onclick="switchDelContact('anjali')" class="p-4 border-b border-gray-800 hover:bg-[#1a1a1a] cursor-pointer transition-colors">
                                <div class="flex justify-between items-center mb-1">
                    ...
                    <div class="flex-1 flex flex-col bg-[#0a0a0a]">
                        <div class="p-4 border-b border-gray-800 flex justify-between items-center">
                            <h4 id="del-chat-header-name" class="text-white font-bold">HQ Logistics Support</h4>
                            <span id="del-chat-header-status" class="text-xs text-green-500 flex items-center"><span class="w-2 h-2 bg-green-500 rounded-full mr-2"></span>Online</span>
                        </div>
                        <div id="del-chat-messages" class="flex-1 p-6 space-y-4 overflow-y-auto">
                            <!-- Messages injected here via JS -->
                        </div>
                        <div class="p-4 border-t border-gray-800 bg-[#111] flex space-x-2">
                            <button class="text-gray-500 hover:text-brand-gold cursor-pointer"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13"></path></svg></button>
                            <input type="text" id="del-chat-input" placeholder="Type a message..." class="flex-1 bg-black border border-gray-700 rounded py-2 px-3 text-sm text-white focus:outline-none focus:border-brand-gold">
                            <button onclick="sendDelMessage()" class="bg-brand-gold text-black px-4 rounded font-bold hover:bg-yellow-500 text-sm cursor-pointer">Send</button>
                        </div>
                    </div>
                </div>
            </div>
